                ...
                : forkTemplates.data ? (
                  forkTemplates.data.map((item, index) => {
                    return (
                      <button
                        key={index}
                        className="flex flex-col items-center justify-center w-32 h-32 sm:w-48 sm:h-48 max-w-xs overflow-hidden rounded-lg shadow-md text-white hover:text-primary bg-primaryContainer transition-shadow duration-300 ease-in-out hover:bg-primaryContainer/[.60] cursor-pointer"
                        onClick={() => {
