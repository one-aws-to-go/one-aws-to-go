...
const Logs = () => {
  return (
    <div className='w-screen h-screen bg-repeat bg-black flex flex-col '>
      <NavBar />
      <div className='bg-black flex flex-1 flex-col justify-start items-center'>
        <div className='mx-auto max-w-7xl px-6 space-y-4 mb-4 flex flex-col items-start'>
          ...
          <p className='rounded-lg box-border px-4 py-2 border-2 border-primary text-white text-start text-sm'>
