...
const Logs = () => {
    return (
        <div
            className='space-y-4 bg-black flex flex-col h-screen justify-start items-center'
        >
            <Menu />
            <div className='w-3/4 m-8 space-y-4 flex flex-col h-screen items-start'>
                ...
                <div className="rounded-lg box-border h-3/5 w-full p-4 border">
                    <p className='text-start text-2xl text-white'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
